...
ISR( INT6_vect ) {
    ...
    boolean leftEncoder_B = digitalRead( ENCODER_0_B_PIN );
    boolean leftEncoder_A = digitalRead( ENCODER_0_A_PIN ); // XORed value
...
ISR( PCINT0_vect ) {
    boolean rightEncoder_B = PINE & (1<<PINE2);
    boolean rightEncoder_A = digitalRead( ENCODER_1_A_PIN );
